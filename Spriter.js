 ...
 * @private
 */
Spriter.prototype.loadConfig = function (options) {
	var spriter = this;
	...
	if (!options.outputDir) {
		throw 'outputDir does not defined in options'
	}
	if (!options.outputDirForCss) {
		throw 'outputDirForCss does not defined in options'
	}
	if (!options.inputPath) {
		throw 'inputPath does not defined in options'
	}
	if (!options.sassPath) {
		throw 'sassPath does not defined in options'
	}
			...
			transform: [ // svg optimisation options
				{
					...
					svgo: {
						...
						plugins: [
							...
							{
								removeAttrs: {attrs: ['data-name', 'g:id', 'path:id']}
							},
